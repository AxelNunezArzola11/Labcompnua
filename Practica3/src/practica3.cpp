...
model = glm::mat4(1.0f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
////segunda piramide invertida centro
		model = glm::mat4(1.0f);
		color=glm::vec3(0.0f,0.0f,1.0f);
...
///piramide azul abajo en el centro:
		model = glm::mat4(1.0f);
		color=glm::vec3(0.0f,0.0f,1.0f);
...
///PIRAMIDE AZUL ABAJO DER  INVERTIDA
...
model = glm::mat4(1.0f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
//PIRAMIDE AZUL ABAJO IZQ INVERTIDA
model = glm::mat4(1.0f);
		color=glm::vec3(0.0f,0.0f,1.0f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
	/////segunda cara color  violeta

////// primera violeta
model = glm::mat4(1.0f);
       color = glm::vec3(0.588235f, 0.294118f, 0.705882f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		///segunda violeta enmedio
	model = glm::mat4(1.0f);
       color = glm::vec3(0.588235f, 0.294118f, 0.705882f);


		model = glm::translate(model, glm::vec3(4.2f, -1.5f, -7.7));
		//Wmodel = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		//model = glm::rotate(model, glm::radians(79.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();	
////segunda piramide  invert cabeza derecha
...
///piramide en el  invert cabeza izq
model = glm::mat4(1.0f);
		color = glm::vec3(0.588235f, 0.294118f, 0.705882f);
...
///piramide viol en el centro der 2 nivel derecha
...
///piramide viol en el centro izquierda:
		model = glm::mat4(1.0f);
		color = glm::vec3(0.588235f, 0.294118f, 0.705882f);
...
model = glm::mat4(1.0f);
       ...
       color = glm::vec3(1.0f, 0.0f, 0.0f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		///segunda centro  enmedio de cabeza
		model = glm::mat4(1.0f);
       color = glm::vec3(1.0f, 0.0f, 0.0f);
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[1]->RenderMesh();
		///segunda centro abajo de cabeza derecho
		model = glm::mat4(1.0f);
       color = glm::vec3(1.0f, 0.0f, 0.0f);
       ...
       color = glm::vec3(0.0f, 1.0f, 0.0f);
		...
		/*
		ejercicios  E03-318520489
model = glm::mat4(1.0);
		model = glm::scale(model, glm::vec3(12.0f, 1.0f, 15.0f));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		...
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 0.0f, 1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 3.0f, -2.2f));
		...
		// Cubo verde Ventana izq Frontal
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(1.2f, 4.0f, 2.3f));
		model = glm::scale(model, glm::vec3(1.3f, 1.5f, 0.5f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();

		// Cubo verde Ventana der Frontal
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(-1.2f, 4.0f, 2.3f));
		model = glm::scale(model, glm::vec3(1.3f, 1.5f, 0.5f));
		...
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.05f, 2.3f));
		model = glm::scale(model, glm::vec3(1.3f, 1.5f, 0.5f));
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		// Cuadrado Cafe Tronco 1
		model = glm::mat4(1.0f);
		...
		// Piramide verde arbol para TRONCO 2
		model = glm::mat4(1.0f);
		...
		// Piramide Verde Arbol Para Tronco 1
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 0.5f, 0.0f);
		model = glm::translate(model, glm::vec3(-5.0f, 3.5f, 0.0f));
		model = glm::scale(model, glm::vec3(0.7f, 3.0f, 0.7f));
		...
		model = glm::mat4(1.0f);
		color = glm::vec3(0.0f, 1.0f, 0.0f);
		model = glm::translate(model, glm::vec3(2.3f, 4.0f, 1.0f));
