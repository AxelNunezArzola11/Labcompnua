...
//Practica 5
Carro_cuerpo=Model();
Carro_cuerpo.LoadModel("Models/jeepcuerpo.obj");
///llanta
Carro_llanta=Model();
Carro_llanta.LoadModel("Models/jeepllanta.obj");
///lanta 2
Carro_llanta2=Model();
Carro_llanta2.LoadModel("Models/jeepllanta2.obj");
///llanta 3
Carro_llanta3=Model();
Carro_llanta3.LoadModel("Models/jeepllanta3.obj");
//llanta 4
Carro_llanta4=Model();
Carro_llanta4.LoadModel("Models/jeepllanta4.obj");
//cajuela
Carro_Cofre=Model();
Carro_Cofre.LoadModel("Models/jeepcofre.obj");
...
///seguna pata delnatera der
	...
	///model = glm::rotate(model, glm::radians(mainWindow.getangulorueda()), glm::vec3(1.0f, 0.0f, 0.0f));
	color = glm::vec3(0.0f, 0.0f, 0.0f); //modelo de goddard de color negro
