...
int main()
{
	...
	CrearCilindro(21, 1.0f);//�ndice 2 en MeshList
...
model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
	...
	////canasta
		model = glm::scale(model, glm::vec3(4.5f, 3.5f, 2.5f));
	...
	////cabina
			...
			//model = glm::translate(model, glm::vec3(1.5f, 6.5f, -4.0f));
		...
		*/
		...
		model = glm::scale(model, glm::vec3(15.0f, 8.0f, 10.0f));
		color = glm::vec3(0.5f, 0.5f, 0.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();
		...
		//CABEZA
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-6.0f, 10.5f, -1.0f));
		...
		///BOCA
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-11.0f, 9.0f, -1.0f));
